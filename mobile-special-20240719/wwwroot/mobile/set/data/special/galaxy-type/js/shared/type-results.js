...
var imageBaseUrl = "/mobile/set/data/special/galaxy-type/img/shared";
window.GALAXY_TYPE.typeResults = [
	{
		id: 1,
		slug: "consultant",
		typeName: "コンサルタント型",
		...
		characterQuote: "結局、判断基準はどこにありますか？",
			imageUrl: imageBaseUrl + "/ogp-consultant.jpg",
			ogpImageUrl: imageBaseUrl + "/ogp-consultant.jpg",
	},
	{
		id: 2,
		slug: "presenter",
		...
		characterQuote: "これ、例えると〇〇みたいな感じなんです！",
			imageUrl: imageBaseUrl + "/ogp-presenter.jpg",
			ogpImageUrl: imageBaseUrl + "/ogp-presenter.jpg",
	},
	{
		id: 3,
		slug: "supporter",
		...
		characterQuote: "ゆっくりで大丈夫ですよ、一緒に考えましょう。",
			imageUrl: imageBaseUrl + "/ogp-supporter.jpg",
			ogpImageUrl: imageBaseUrl + "/ogp-supporter.jpg",
	},
	{
		id: 4,
		...
		characterQuote: "要するに、解決策はこれ一点ですね。",
			imageUrl: imageBaseUrl + "/ogp-speed-responder.jpg",
			ogpImageUrl: imageBaseUrl + "/ogp-speed-responder.jpg",
	},
	{
		id: 5,
		slug: "demonstrator",
		...
		characterQuote: "説明するより、一度やってみた方が早いですよ！",
			imageUrl: imageBaseUrl + "/ogp-demonstrator.jpg",
			ogpImageUrl: imageBaseUrl + "/ogp-demonstrator.jpg",
	},
	{
		id: 6,
		slug: "closer",
		...
		characterQuote: "決まらない理由は、価格ですか？性能ですか？",
			imageUrl: imageBaseUrl + "/ogp-closer.jpg",
			ogpImageUrl: imageBaseUrl + "/ogp-closer.jpg",
	},
	{
		id: 7,
		slug: "all-rounder",
		...
		characterQuote: "あ、今は詳しく聞くより結論が欲しい感じかな？",
			imageUrl: imageBaseUrl + "/ogp-all-rounder.jpg",
			ogpImageUrl: imageBaseUrl + "/ogp-all-rounder.jpg",
	},
	{
		id: 8,
		slug: "advisor",
		...
		characterQuote: "長く使うものだから、後悔はしてほしくないんです。",
			imageUrl: imageBaseUrl + "/ogp-advisor.jpg",
			ogpImageUrl: imageBaseUrl + "/ogp-advisor.jpg",
	},
];
